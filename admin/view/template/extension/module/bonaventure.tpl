...
<div id="content"><div class="container-fluid">
	<div class="page-header">
	    <h1>Bonaventure Theme Options</h1>
	    <ul class="breadcrumb">
	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		...
		<div id="tb_store_select">
			...
			<?php foreach ($stores as $store): ?>
				<option value="<?php echo 'index.php?route=extension/module/bonaventure&store_id=' . $store['store_id'] . '&user_token=' . $_GET['user_token']; ?>"<?php if($store_id == $store['store_id']) echo ' selected="selected"'; ?>><?php echo $store['name']; ?></option>
			<?php endforeach; ?>
			</select>
		</div>
