...
class ControllerExtensionModuleTfFilter extends Controller {
        ...
        private function getSubCategoryFilter(){
                ...
                foreach($sub_categories as $sub_category){
                    ...
                    if(isset($post_filter_sub_categories[$sub_category['category_id']])){
                        $status = true;
                        $total = $post_filter_sub_categories[$sub_category['category_id']]['total'];
                    } elseif($filter_param) {
                        $status = false;
        ...
        private function loadData(){
                ...
                if(($this->info && $this->info['filter']['manufacturer']['status']) || isset($this->request->get['_f_manufacturer']) || isset($filter_param['filter_manufacturer_id'])){
