		...
		foreach ($results as $result) {
			$data['filters'][] = array(
				...
				'edit'        => $this->url->link('extension/maza/tf_filter/edit', 'user_token=' . $this->session->data['user_token'] . '&filter_id=' . $result['filter_id'] . $url, true),
                                'value_edit'        => $this->url->link('extension/maza/tf_filter/value', 'user_token=' . $this->session->data['user_token'] . '&filter_id=' . $result['filter_id'] . $url, true),
			);
		}
		...
		if (isset($this->request->get['page'])) {
			...
			$page = 1;
                ...
                if(isset($this->request->get['filter_id'])){
                    $header_data['menu'][] = array('name' => $this->language->get('tab_value'), 'id' => 'tab-tf-value', 'href' => $this->url->link('extension/maza/tf_filter/value', 'user_token=' . $this->session->data['user_token'] . '&filter_id=' . $this->request->get['filter_id'] . $url));
                }
