...
class ModelAccountAddress extends Model {
	...
	public function getAddress($address_id) {
		...
		if ($address_query->num_rows) {
			...
			$city_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "city` WHERE " . DB_PREFIX . "city.name = '" . $address_query->row['city'] . "' AND " . DB_PREFIX . "city.zone_id = '" . (int)$address_query->row['zone_id'] . "'");
	...
	public function getAddresses() {
		...
		foreach ($query->rows as $result) {
			...
			$city_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "city` WHERE " . DB_PREFIX . "city.name = '" . $result['city'] . "' AND " . DB_PREFIX . "city.zone_id = '" . (int)$result['zone_id'] . "'");
