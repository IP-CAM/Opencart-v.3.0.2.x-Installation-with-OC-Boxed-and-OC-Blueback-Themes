<?php
// Heading
$_['heading_title']                  = 'Finalizează comanda';
...
$_['text_register_account']          = 'Prin crearea unui cont vei putea să cumperi mai rapid, să fii la curent cu statusul comenzi, să ții evidența comenzilor precedente și multe altele.';
...
$_['text_recurring_item']            = 'Produs abonament';
$_['text_payment_recurring']         = 'Abonamentul';
$_['text_trial_description']         = '%s la fiecare %d %s(s) pentru %d plăți apoi';
$_['text_payment_description']       = '%s la fiecare %d %s(s) pentru %d plăți';
$_['text_payment_cancel']			 = '%s la fiecare %d %s(s) până la anulare';
$_['text_day']                       = 'zi';
...
$_['entry_address_1']                = 'Stradă, Număr, Apartament:';
$_['entry_address_2']                = 'Addresă2 :';
$_['entry_postcode']                 = 'Cod Poștal';
$_['entry_city']                     = 'Localitate';
$_['entry_country']                  = 'Țară';
$_['entry_zone']                     = 'Județ';
$_['entry_newsletter']               = 'Vreau să mă abonez la newsletter-ul  %s .';
$_['entry_shipping'] 	             = 'Adresa mea de livrare este aceeași cu cea de facturare.';

// Error
$_['error_warning']                  = 'A intervenit o problemă în timp ce comanda era procesată! Dacă problema persistă, încearcă să selectezi o altă metodă de plată sau  <a href="%s">contactează-ne</a>.';
$_['error_login']                    = 'Eroare: E-mail sau parolă invalidă.';
...
$_['error_approved']                 = 'Eroare: Contul tău trebuie să fie aprobat inainte să te poti autentifica.';
$_['error_exists']                   = 'Eroare: Adresa de e-mail este deja înregistrată!';
...
$_['error_email']                    = 'Adresa de e-mail este invalidă!';
...
$_['error_confirm']                  = 'Confirmarea parolei nu coincide cu parola!';
$_['error_address_1']                = 'Adresa 1 trebuie să conțină între 3 și 128 de caractere!';
$_['error_city']                     = 'Orașul trebuie să conțină între 2 și 128 de caractere!';
$_['error_postcode']                 = 'Codul Poștal trebuie să contonă între 2 și 10 caractere!';
$_['error_country']                  = 'Selectează o țară!';
$_['error_zone']                     = 'Selectează un județ!';
$_['error_agree']                    = 'Eroare: Trebuie să fi de acord cu %s!';
$_['error_address']                  = 'Eroare: Trebuie să selectezi adresa!';
...
$_['error_payment']                  = 'Eroare: Selectează o metodă de plată!';
$_['error_no_payment']               = 'Eroare: Nicio metodă de plata disponibilă. Te rugăm să <a href="%s">ne contactezi</a> pentru asistență!';
