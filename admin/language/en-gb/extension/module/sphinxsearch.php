...
//General tab
$_['entry_module_sphinxsearch_status']        = 'Sphinx Search Status:';
$_['entry_sort_status']        = 'Sort status:';
$_['entry_module_sphinxsearch_server']        = 'Sphinx server:';
$_['entry_module_sphinxsearch_port']        = 'Sphinx port:';
$_['entry_module_sphinxsearch_match_mode_title'] = 'Matching mode';
$_['entry_module_sphinxsearch_sort_mode_title'] = 'Sort mode';
$_['entry_module_sphinxsearch_ranking_mode_title'] = 'Ranking mode';
$_['entry_module_sphinxsearch_weight_title'] = 'Sphinx weights';
$_['entry_module_sphinxsearch_gen_suggestions'] = 'Generate suggestions';
$_['entry_module_sphinxsearch_match_mode'] = 'Choose sphinx match mode:';
$_['entry_module_sphinxsearch_sort_info'] = 'Sort mode';
$_['entry_module_sphinxsearch_attr_expr_info'] = 'Attribute/Expression';
$_['entry_module_sphinxsearch_ranking_mode'] = 'Choose sphinx ranking mode:';

$_['entry_module_sphinxsearch_match_modes_explanation']	= '&bull; SPH_MATCH_ALL, matches all query words (default mode)<br />
		...
		';
$_['entry_module_sphinxsearch_sort_modes_explanation']	= '&bull; SPH_SORT_RELEVANCE mode, that sorts by relevance in descending order (best matches first)<br />
		...
		';
$_['entry_module_sphinxsearch_ranking_modes_explanation']	= '&bull; SPH_RANK_PROXIMITY_BM25, the default ranking mode that uses and combines both phrase proximity and BM25 ranking.<br />
		...
		';
$_['entry_module_sphinxsearch_suggestion_explanation'] = 'This will generate a table with all keywords from the product\'s name column inside product_description table, build trigrams and freqs.';

//Autocomplete tab
$_['entry_module_sphinxsearch_autocomplete'] = 'Sphinx autocomplete';
...
$_['entry_module_sphinxsearch_autocomplete_cat_limit'] = 'Maximum number of categories to display';

//Products tab
$_['entry_module_sphinxsearch_product_status'] = 'Show products which status is Disabled';
//$_['entry_module_sphinxsearch_product_stock_status'] = 'Choose which product\'s stock statuses should be included in the results.';
$_['entry_module_sphinxsearch_products_quantity'] = 'Show products which quantity min values is:';

//Categories tab
$_['entry_module_sphinxsearch_category_status'] = 'Enable sphinx for categories';
$_['entry_module_sphinxsearch_category_product_status'] = 'Show products which status is Disabled';
$_['entry_module_sphinxsearch_categories_product_quantity'] = 'Show products which quantity min values is:';

//Suggestions tab
$_['text_gen_suggestions_success'] = 'The suggestion\'s table was regenerated successfully!';
$_['entry_module_sphinxsearch_gen_btn'] = 'Generate suggestions';
$_['entry_module_sphinxsearch_show_errors_attention'] = 'In order to see errors from Sphinx module, please set \'Display Errors\' inside System->Settings->Server to \'No\'. If you don\'t want to set it, then all errors will be logged inside error.log file.';

//Config tab
$_['entry_module_sphinxsearch_config_attention'] = 'Note: If you have used Sphinx with \'RT index\' type, before start using the \'Regular index\' type, make sure you have done the following steps: </br > 1. Generate a new sphinx config file. <br /> 2. Delete all previous indexes from the \'data path\' you have specified in the \'Config file tab\'. <br /> 3. Run indexer to generate the regular indexes!';
$_['entry_module_sphinxsearch_config_index_type'] = 'Choose index type:';
$_['entry_module_sphinxsearch_config_path_to_indexes'] = 'Enter the path where the indexes will be stored: <br /> ex. /var/www/sphinx/data';
$_['entry_module_sphinxsearch_config_path_to_log'] = 'Enter the path where the log will be stored: <br /> ex. /var/www/sphinx/log';
$_['entry_module_sphinxsearch_config_generate_file'] = 'Generate sphinx config file';
$_['entry_module_sphinxsearch_gen_config_btn'] = 'Generate';

//Index type tab
$_['entry_module_sphinxsearch_rtIndex_attention'] = 'Note: If you have used Sphinx with \'Regular index\' type, before start using the \'RT index\' type, make sure you have done the following steps:  </br > 1. Generate a new sphinx config file. <br /> 2. Delete all previous indexes from the \'data path\' you have specified in the \'Config file tab\'! <br /> <br /> In order to see errors from Sphinx module, please set \'Display Errors\' inside System->Settings->Server to \'No\'. If you don\'t want to set it, then all errors will be logged inside error.log file.';
$_['entry_module_sphinxsearch_rtIndex_gen_products_btn'] = 'Build Products RT index';
$_['entry_module_sphinxsearch_rtIndex_gen_categories_btn'] = 'Build Categories RT index';
