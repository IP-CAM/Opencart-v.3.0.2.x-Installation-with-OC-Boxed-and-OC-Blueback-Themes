...
class ControllerExtensionModuleTfFilter extends Controller {
		...
		$this->document->setTitle($this->language->get('heading_title'));
                ...
                if (!isset($this->request->get['module_id'])) {
			$data['action'] = $this->url->link('extension/module/tf_filter', 'user_token=' . $this->session->data['user_token'] . $url);
		} else {
...
//                $setting['sub_category']      =   1;
                ...
                // Text
                $data['help_custom'] = sprintf($this->language->get('help_custom'), $this->url->link('extension/maza/tf_filter', 'user_token=' . $this->session->data['user_token'] . $url));
                $data['help_filter'] = sprintf($this->language->get('help_filter'), $this->url->link('catalog/filter', 'user_token=' . $this->session->data['user_token'] . $url));
