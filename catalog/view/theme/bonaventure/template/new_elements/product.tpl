             ...
             <?php if($theme_options->get( 'display_add_to_wishlist' ) != '0') { ?>
				...
				<?php } ?>
		          ...
		          <?php if($theme_options->get( 'display_add_to_cart' ) != '0') { ?>
		               ...
		               <?php } else { ?>
		               <li class="add-to-cart"><a onclick="cart.add('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" data-original-title="<?php echo $button_cart; ?>">Add To Cart</a></li>
		               <?php } ?>
		          <?php } ?>
				...
				<li><a onclick="compare.add('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" data-original-title="<?php if($theme_options->get( 'add_to_compare_text', $config->get( 'config_language_id' ) ) != '') { echo $theme_options->get( 'add_to_compare_text', $config->get( 'config_language_id' ) ); } else { echo 'Add to compare'; } ?>"><i class="fa fa-signal"></i></a></li>
				<?php } ?>
